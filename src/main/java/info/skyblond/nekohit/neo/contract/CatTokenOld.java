...
public class CatTokenOld {
    ...
    public static String queryWCA(Hash160 owner, String identifier) {
        ...
        WCAPojo result = new WCAPojo(basicInfo.stakePer100Token, basicInfo.maxTokenSoldCount,
                buyerInfo.remainTokenCount, basicInfo.endTimestamp);

        return StdLib.jsonSerialize(result);
    }

    public static void createWCA(Hash160 owner, int stakePer100Token, int maxTokenSoldCount, int endTimestamp,
