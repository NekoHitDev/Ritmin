...
public class GASFeeTest extends ContractTestFramework{
    ...
    void test() throws Throwable {
        ...
        ContractTestFramework.transferToken(
                ContractTestFramework.getCatToken(), this.creatorWallet,
        ...
        ContractTestFramework.transferToken(
                ContractTestFramework.getCatToken(), this.buyer1Wallet,
                ContractTestFramework.getWcaContractAddress(),
                200,
                id, true
        );
        ...
        ContractTestFramework.transferToken(
                ContractTestFramework.getCatToken(), this.buyer2Wallet,
                ContractTestFramework.getWcaContractAddress(),
                500,
                id, true
        );
