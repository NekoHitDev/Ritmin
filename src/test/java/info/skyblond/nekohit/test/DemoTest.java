...
import static info.skyblond.nekohit.example.Constants.CAT_TOKEN;
...
public class DemoTest {
    ...
    @Test
    void passDemo() throws UnexpectedReturnTypeException, IOException {
        assertEquals(0, GAS_TOKEN.getBalanceOf(CONTRACT_OWNER_ACCOUNT).intValue());
    }

    @Test
    void failedDemo() throws UnexpectedReturnTypeException, IOException {
        assertEquals(10, CAT_TOKEN.getBalanceOf(CONTRACT_OWNER_ACCOUNT).intValue());
    }
}
